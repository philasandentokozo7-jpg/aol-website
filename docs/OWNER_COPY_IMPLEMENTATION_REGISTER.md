...
| `/` `#services` | `src/components/sections/Services.tsx` | Short AI-style descriptions; “Cloud Accounting / Xero”; no “View All Services.” | Heading, intro, 10 service names; 8 locked descriptions; title-only for Accounting & Bookkeeping and Payroll; “View All Services.” | implemented | Yes (locked items); title-only where owner copy missing |
