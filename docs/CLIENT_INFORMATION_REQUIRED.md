...
| Owner confirmation of Payroll Administration full wording | Full service paragraph | Built from established payroll scope already in the project (PAYE/UIF/SDL/payslips/submissions/records); confirm if a longer owner paragraph exists |

## Confirmed and implemented

* Business name: AOL Accounting Academy SA
...
* Genuine client testimonials + publication permission
* Full insight / article content
* Formal accounting programmes / calendars / enrolment (only if operationally real)
* Payments / learner portals
* Verified statistics
* Additional industries beyond the approved list

Optional items are **not** current launch blockers unless the website publicly promises them.
